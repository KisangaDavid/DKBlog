---
title: "Puzzle: 100 Prisoners and a Light Bulb (Part 1)"
slug: 100-prisoners-1-lightbulb-part-1
...
> Note: Everyone I've talked to who was familiar with this puzzle had only ever heard of solution #2. However, there exist much better solutions, 
>which will be shown below and in part $2$ of the post!
...
[Solution #3: Staged Counter Selection](#solution-3-staged-counter-selection) <br /> <br />
...
The simulations back up our calculations! Using this procedure the prisoners should expect to be free in around $10{,}417$ days, or just over $28.5$ years. This is much more reasonable than solution #$1$, but we can still do better!
<br /> <br />
...
The simulation once again matches up with our calculations 😊. Using this procedure, 
the prisoners should expect to be free in $9{,}384$ days, or roughly $25.7$ years. 
We were able to shave almost three years off of the standard one counter solution! <br />

## Conclusion:
The prisoners might be a little more wrinkly and grey by the time they're out, but at least they'll taste freedom again in their lifetimes. However, what if I told you that 
these are actually extremely kind prisoners who walk grandmas across the street and save puppies in their free time? Well then, they must obviously be freed expeditiously!
Check out [part two](https://www.blog.dkisanga.com/100-prisoners-1-lightbulb-part-2) of this post to see how we can optimize these procedures and free the prisoners even faster!