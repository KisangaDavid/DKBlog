...
<style is:global>{`
    ...
    .table-scroll td .katex {
        ...
        scrollbar-color: #738aa7 transparent;
    }

    .table-scroll td .katex::-webkit-scrollbar {
        height: 4px;
    }

    .table-scroll td .katex::-webkit-scrollbar-track {
        background: transparent;
    }

    .table-scroll td .katex::-webkit-scrollbar-thumb {
        background: #738aa7;
        border-radius: 999px;
    }
