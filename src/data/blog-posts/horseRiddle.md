...
<style>
  ...
  .image-container .triple-image-and-caption {
  display: flex;
  width: 33%;
...
race with the horse that came directly behind it in its original group.
The winner of this race is guaranteed to be the
second fastest horse. An 8th race is constructed in the
same fashion - the winner of the 7th race is replaced with the
horse that came directly behind it in its original group
...
![alt text](../../assets/racesBreakdown.jpg)
...
races, determine if the submitted horses ***must*** be the
fastest 3. We can verify this by constructing a simple graph.
...
![1st Place Horse](../../assets/horseBreakdownCompleteGraph.png) 
<div classname="caption-text">
...
<div classname="triple-image-and-caption">

![2nd Place Horse](../../assets/horseBreakdown2ndPlaceGraph.png) 
<div classname="caption-text">
...
![3rd Place Horse](../../assets/horseBreakdown3rdPlaceGraph.png) 
<div classname="caption-text">
...
![4th Place Horse](../../assets/horseBreakdown4thPlaceGraph.png) 
<div classname="caption-text">
